...
``src/dsh_macos_pet/imaging.py`` now, and this script imports them. ``scripts/``
...
from dsh_macos_pet.anim import auto_timeline  # noqa: E402  (needs the path above)
from dsh_macos_pet.imaging import (  # noqa: E402
    ALPHA_CUTOFF,
    BASELINE_RATIO,
    FRAME_SIZE,
    PLATE_DISTANCE,
