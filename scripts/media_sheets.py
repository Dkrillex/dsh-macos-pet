...
The still strips come from `dsh_macos_pet.sheets`, which ships — anyone who
installed the plugin can produce the same image for their own skin with
`dsh-macos-pet --skin-sheet <id>`. Only the animated loops live here, because
...
from dsh_macos_pet import imaging, packs, sheets  # noqa: E402
