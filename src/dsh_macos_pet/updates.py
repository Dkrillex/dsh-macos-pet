...
* **The package name comes from the manifest, never a literal.** This package
  has been renamed once already, and the failure mode is quiet: a stale literal
  still resolves, just to somebody else's package, so the menu reports their
  releases as ours instead of erroring.
"""
