...
from dsh_macos_pet import updates
...
class QueryTests(unittest.TestCase):
    def test_queries_the_manifest_name_not_a_literal(self) -> None:
        ...
        self.assertEqual(updates.package_name(), "dsh-macos-pet")
...
class LabelTests(unittest.TestCase):
    def test_newer_version_names_it_and_the_upgrade_command(self) -> None:
        ...
        text = updates.label("0.1.0", "0.2.0", upgrade_hint="dsh plugin add dsh-macos-pet")
