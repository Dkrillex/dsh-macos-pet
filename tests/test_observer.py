...
from dsh_macos_pet.mapper import map_activity
from dsh_macos_pet.observer import observe_activity
...
class ObserverTests(unittest.TestCase):
    ...
    def test_quiet_sessions_never_shell_out_to_ps(self) -> None:
        ...
        import dsh_macos_pet.observer as observer
    ...
    def test_only_the_tail_of_a_session_file_is_read(self) -> None:
        ...
        from dsh_macos_pet.observer import TAIL_BYTES, _kind_from_session_tail
